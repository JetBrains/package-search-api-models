...
class MetadataTest : BuildSystemsTestBase() {
    @ParameterizedTest
    @ValueSource(strings = ["gradle/specification-example.module", "gradle/ktor-client-core-2.2.1.module"])
    fun `parse module metadata from resources`(path: String) = runTest {
