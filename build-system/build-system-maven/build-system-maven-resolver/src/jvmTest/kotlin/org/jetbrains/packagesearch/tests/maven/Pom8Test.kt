...
import org.jetbrains.packagesearch.maven.resolver.HttpClientMavenArtifactDownloader
import org.jetbrains.packagesearch.maven.resolver.PomResolver
import org.jetbrains.packagesearch.maven.resolver.SimpleMavenUrlBuilder
import org.jetbrains.packagesearch.maven.resolver.decodeFromString
...
class Pom8Test : BuildSystemsTestBase() {
    ...
    fun testSolver(coordinates: String) =
        runTest {
            ...
            val urlBuilder = SimpleMavenUrlBuilder("https://repo.maven.apache.org/maven2/")
            val pomProviders =
                listOf(HttpClientMavenArtifactDownloader(urlBuilder, httpClient))
