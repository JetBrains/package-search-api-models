...
object GradleVariantSerializer : JsonContentPolymorphicSerializer<GradlePackage.Variant>(GradlePackage.Variant::class) {
    ...
    override fun selectDeserializer(element: JsonElement): DeserializationStrategy<GradlePackage.Variant> = when {
        "available-at" in element.jsonObject ->
            GradlePackage.Variant.WithAvailableAt.serializer()
        "files" in element.jsonObject && "dependencies" in element.jsonObject ->
            GradlePackage.Variant.WithFiles.serializer()
