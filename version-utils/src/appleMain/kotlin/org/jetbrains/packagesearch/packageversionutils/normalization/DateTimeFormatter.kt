...
public fun NSDateFormatter(pattern: String): NSDateFormatter = NSDateFormatter().apply { dateFormat = pattern }

public actual fun DateTimeFormatter(pattern: String): DateTimeFormatter = DateTimeFormatter(NSDateFormatter(pattern))
...
public actual class DateTimeFormatter internal constructor(private val delegate: NSDateFormatter) {
    public actual fun parseOrNull(dateTimeString: String): LocalDateTime? =
        delegate.dateFromString(dateTimeString)
